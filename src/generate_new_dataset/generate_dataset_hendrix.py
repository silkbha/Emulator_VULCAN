...
def main(num_workers, generate=True, time_series=True):
    ...
    if mode == '':
        if time_series:
            dataset_dir = os.path.join(data_maindir, 'time_series_dataset_hendrix')
        else:
            dataset_dir = os.path.join(data_maindir, 'dataset_hendrix')
    else:
        dataset_dir = os.path.join(data_maindir, f'{mode}_dataset_hendrix')
