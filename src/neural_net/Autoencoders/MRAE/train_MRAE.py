...
from src.neural_net.dataloaders import MixingRatioVulcanDataset
from src.neural_net.dataset_utils import make_data_loaders
from src.neural_net.NN_utils import move_to, plot_single_y_mix, derivative_MSE, LossWeightScheduler, plot_variable
from src.neural_net.ConvAE.MRAE.MixingRatioAE import MixingRatioAE
...
def main():
    ...
    save_model_dir = os.path.join(MRP_dir, 'src/neural_net/saved_models_final')
    log_dir = os.path.join(MRP_dir, 'src/neural_net/runs_final')
